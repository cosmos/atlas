...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: "/blog-posts",
      name: "blog-posts",
      components: { header: AppHeader, default: BlogPosts, footer: AppFooter }
    },
    {
      path: "/blog-post",
      name: "blog-post",
      components: { header: AppHeader, default: BlogPost, footer: AppFooter }
    },
    {
      path: "/contact-us",
      name: "contact-us",
    ...
    },
    {
      path: "/register",
      name: "register",
      components: { header: AppHeader, default: Register, footer: AppFooter }
    },
    {
      path: "/login",
      name: "login",
      components: { header: AppHeader, default: Login, footer: AppFooter }
    },
    {
      path: "/reset",
      name: "reset",
      components: { header: AppHeader, default: Reset, footer: AppFooter }
    },
    {
      path: "/invoice",
      name: "invoice",
      components: { header: AppHeader, default: Invoice, footer: AppFooter }
    },
    {
      path: "/chat-page",
      name: "chat-page",
      components: { header: AppHeader, default: ChatPage, footer: AppFooter }
    },
    {
      path: "/product-page",
      name: "product-page",
    ...
    },
    {
      path: "/checkout",
      name: "checkout",
      components: { header: AppHeader, default: Checkout, footer: AppFooter }
    }
  ],
  scrollBehavior: to => {
    if (to.hash) {
